    ...
    <body>
        <div class="contenedor">
            ...
            <main class="contenido">
                ...
                <nav class="menu" data-aos="fade-down" data-aos-delay="1000" data-aos-duration="1000">                                                       
                ...
                <div class="imagenFondo">
                    <div class="txtVision">                        
                        <p>"Lorem ipsum dolor sit amet, consectetur<br> adipiscing elit, sed do eiusmod tempor incididunt<br> ut labore et dolore magna aliqua. Ut enim ad<br> minim veniam, quis nostrud exercitation<br> ullamco laboris nisi"</p>
                    </div>
                </div>
                <!--  ***** Fin sección texto de la visión ***** -->
